...
- `add_company_merge_history.py` - Adds audit table for company merge operations (2026-03-22)
- `add_pipeline_week3_features.py` - Adds CPQ, taxonomy, hygiene, forecast and revenue model fields (2026-03-22)
